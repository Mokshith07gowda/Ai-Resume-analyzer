...
def extract_languages(text: str) -> list:
    """
    Extract programming and spoken languages from resume.
    ...
    programming_languages = ["Python", "Java", "JavaScript", "C++", "C#", "Ruby", "PHP", 
                            "Swift", "Kotlin", "Go", "Rust", "TypeScript", "C", "R", 
                            "SQL", "HTML", "CSS", "MATLAB", "Scala", "Perl"]
    
    spoken_languages = ["English", "Hindi", "Spanish", "French", "German", "Chinese", 
                       "Japanese", "Korean", "Arabic", "Portuguese", "Russian", 
                       "Italian", "Telugu", "Tamil", "Kannada", "Malayalam", "Bengali", "Marathi"]
    
    all_languages = programming_languages + spoken_languages
    found_languages = []
    text_lower = text.lower()
    ...
    return found_languages if found_languages else ["Not specified"]
